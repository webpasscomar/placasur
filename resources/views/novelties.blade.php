                ...
                <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            aria-controls="{{ strtolower($category->name) }}-tab-pane" aria-selected="true">{{
                            $category->name }}
                        </button>
                    </li>
                    @endforeach
                        ...
                        <div class="row py-3 px-2 shadow rounded-2">
                            ...
                            <div class="col">
                                <span
                                    ...
                                    date('d M Y', strtotime($novelty->created_at)) }}</span>
                                ...
                                <div class="card text-bg-light p-0 info-box__shadow h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary" role="button"
                                            data-bs-toggle="modal" data-bs-target="#exampleModal{{ $novelty->id }}"> Ver
                                            nota
                                            <i class="fas fa-chevron-right ml-3"></i>
                                        </button>
                                    </div>
