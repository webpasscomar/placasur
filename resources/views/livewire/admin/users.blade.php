        ...
        @foreach ($users as $user)
          <tr>
            ...
            <td class="p-1 text-center">
              <button wire:click="edit({{ $user->id }})" class="btn btn-sm btn-primary" data-toggle="modal"
              ...
              <button wire:click="changepass({{ $user->id }})" class="btn btn-sm btn-info" data-toggle="modal"
                data-target="#roleModal" title="Cambia Password"><i class="fas fa-key"
                  style="color: white "></i></button>
              <button wire:click="roles({{ $user->id }})" class="btn btn-sm btn-warning" data-toggle="modal"
                data-target="#roleModal" title="Roles"><i class="fa fa-bars"></i></button>
            </td>
          </tr>
        @endforeach
      </tbody>
          ...
          <div class="modal-body">
            ...
            <div class="col-md-4 text-right float-right mb-1">
              <button wire:click="newRole" class="btn btn-success" data-toggle="modal"
                data-target="#roleModalRole"><i class="fas fa-plus-circle mr-2" style="color: white;"></i>Agregar
                Role</button>
            </div>
