                    ...
                    <tbody>
                        @foreach ($filas as $key => $fila)
                            <tr>
                                ...
                                <td class="align-middle" style="cursor: pointer"
                                    wire:click="openModalImage({{ $fila->id }})"><img
                                        src="{{ file_exists(public_path('storage/galerias/' . $fila->imagen)) ? asset('storage/galerias/' . $fila->imagen) : asset('img/no_disponible.png') }}"
                            ...
                            @if ($showModalImage)
                                ...
                                <x-modal-image
                                    image="{{ file_exists(public_path('storage/galerias/' . $currentImage)) ? asset('storage/galerias/' . $currentImage) : asset('img/no_disponible.png') }}"
