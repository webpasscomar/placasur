                ...
                <table class="table table-hover table-striped table-bordered mt-3 datatable" id="myTable">
                    ...
                    @foreach ($marcas as $key => $marca)
                        <tr>
                            ...
                            <td class="align-middle" style="cursor: pointer"
                                wire:click="openModalImage({{ $marca->id }})"><img
                                    src="{{ $marca->imagen ? asset('storage/marcas/' . $marca->imagen) : asset('img/no_disponible.png') }}"
                                    alt="{{ $marca->marca }}" width="40" height="40"/>
                            </td>
                            <td class="align-middle">{{ strtoupper(substr($marca->marca,0,1)).substr($marca->marca,1) }}</td>
                        ...
                        @if ($showModalImage)
                            ...
                            <x-modal-image image="{{ asset('storage/marcas/' . $currentImage) }}"
